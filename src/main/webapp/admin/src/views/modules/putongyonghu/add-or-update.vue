<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属部门" prop="suoshubumen">
          <el-input v-model="ruleForm.suoshubumen" 
              placeholder="所属部门" clearable  :readonly="ro.suoshubumen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所属部门" prop="suoshubumen">
              <el-input v-model="ruleForm.suoshubumen" 
                placeholder="所属部门" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shenfenzhenghao = true;
          ...
          if(o=='suoshubumen'){
            this.ruleForm.suoshubumen = obj[o];
	    this.ro.suoshubumen = true;
            continue;
          }
          if(o=='gerenxiangpian'){
